  ...
  return (
    <div className="min-h-screen bg-white dark:bg-zinc-950 transition-colors duration-300 py-12">
      <div className="max-w-6xl mx-auto p-6 md:p-12">
        ...
        {/* --- WHY CHOOSE W2W CARD TILES SECTION (FULLY UPDATED WITH PREMIUM IMAGES) --- */}
        <div className="bg-gray-50 dark:bg-zinc-900 rounded-[2.5rem] p-8 md:p-12 border border-gray-100 dark:border-zinc-800 shadow-sm mb-20 transition-colors duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            {/* 1. Fair Value for Waste - IMAGE UPDATED */}
            <div className="bg-white dark:bg-zinc-950 rounded-3xl border border-gray-100 dark:border-zinc-800/50 hover:shadow-2xl transition-all duration-300 overflow-hidden flex flex-col group">
              <div className="h-44 overflow-hidden relative">
                <img 
                  src="https://images.unsplash.com/photo-1559526324-4b87b5e36e44?auto=format&fit=crop&q=80&w=400" 
                  alt="Financial reward cash transaction for recycling scrap" 
                  className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500"
                />
                <div className="absolute top-4 right-4 bg-white/90 dark:bg-zinc-900/90 backdrop-blur-md px-3 py-1 rounded-xl text-xl">💰</div>
              </div>
              <div className="p-6 flex-1 flex flex-col">
                ...
                <p className="text-gray-500 dark:text-zinc-400 text-sm font-medium leading-relaxed">
                  We collect your waste products and provide an equivalent monetary value in return, ensuring that recycling is financially rewarding for everyone.
                </p>
              </div>
            </div>
            
            {/* 2. Environmental Protection - IMAGE UPDATED */}
            <div className="bg-white dark:bg-zinc-950 rounded-3xl border border-gray-100 dark:border-zinc-800/50 hover:shadow-2xl transition-all duration-300 overflow-hidden flex flex-col group">
              <div className="h-44 overflow-hidden relative">
                <img 
                  src="https://images.unsplash.com/photo-1530587191325-3db32d826c18?auto=format&fit=crop&q=80&w=400" 
                  alt="Clear nature ecosystem landscape clean environment" 
                  className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500"
                />
                <div className="absolute top-4 right-4 bg-white/90 dark:bg-zinc-900/90 backdrop-blur-md px-3 py-1 rounded-xl text-xl">🛡️</div>
              </div>
              <div className="p-6 flex-1 flex flex-col">
                ...
                <p className="text-gray-500 dark:text-zinc-400 text-sm font-medium leading-relaxed">
                  By systematically collecting and upcycling waste payloads, we actively protect our global ecosystem from pollution and toxic landfill blocks.
                </p>
              </div>
            </div>
            
            {/* 3. Building Future India - IMAGE UPDATED */}
            <div className="bg-white dark:bg-zinc-950 rounded-3xl border border-gray-100 dark:border-zinc-800/50 hover:shadow-2xl transition-all duration-300 overflow-hidden flex flex-col group">
              <div className="h-44 overflow-hidden relative">
                <img 
              ...
              <div className="p-6 flex-1 flex flex-col">
                ...
                <p className="text-gray-500 dark:text-zinc-400 text-sm font-medium leading-relaxed">
                  Our mission is to build a highly sustainable, technology-driven, and waste-free Future India through innovative software architectures and community action.
                </p>
              </div>
            </div>
