...
// MACHI: Direct-ah Render link-aye kuduthudalam, Vercel-la .env illanaalum correct-ah work aagum
...
const Register = () => {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      // Backend Register API call - hardcoded API_URL ensures it doesn't hit localhost
